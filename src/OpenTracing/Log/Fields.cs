...
namespace OpenTracing.Log
{
    ...
    internal static class Fields
    {
        ...
        /// </summary>
        public static readonly string ErrorKind = "error.kind";

        /// <summary>
        ///     The actual Throwable/Exception/Error object instance itself. E.g., A java.lang.UnsupportedOperationException
        ///     instance
        /// </summary>
        public static readonly string ErrorObject = "error.object";
