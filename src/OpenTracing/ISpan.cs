...
namespace OpenTracing
{
    ...
    ///     <seealso cref="ISpanBuilder.StartManual"/>
    ...
    public interface ISpan
    {
        ...
        /// <summary>
        ///     Like <see cref="Log(IDictionary{string,object})" />, but with an explicit
        ///     timestamp.
        ///     <para>
        ///         <em>CAUTIONARY NOTE:</em> not all Tracer implementations support key:value log fields end-to-end.
        ///         Caveat emptor.
        ...
        ///     <para>
        ///         With the exception of calls to <see cref="ISpan.Context" />, this should be the last call made to the
        ///         span instance.
        ///         Future calls to <see cref="Finish()" /> are defined as noops, and future calls to methods other than
        ///         <see cref="ISpan.Context" />
